    ...
    <div className="mx-auto max-w-md p-6">
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        ...
        <input
          ...
          required
        />
        {confirmMismatch && <p className="text-sm text-orange-600">Mật khẩu xác nhận chưa khớp.</p>}
        <button className="w-full rounded bg-black px-3 py-2 text-white">Cập nhật</button>
        {ok && (
          <p className="text-sm text-green-600">Đổi mật khẩu thành công. Vui lòng đăng nhập lại.</p>
        )}
